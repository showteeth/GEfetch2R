...
* `LoadRData` supported `SeuratObject` generated by `Seurat v5`.
...
* Large-scale evaluation:
  * Load count matrix generated by `featureCounts` from GEO (smart-seq2)
  * Load count matrix with extra columns from GEO (smart-seq2)
  * Load count matrix generated by `STAR` from GEO (smart-seq2)
